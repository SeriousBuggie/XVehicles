...
defaultproperties
{
	...
	ZoneAmbPitch=64
	ZoneAmbVolume=128
	SplashClass(0)=Class'WaterVertSplashA00'
	SplashClass(1)=Class'WaterVertSplashA01'
	SplashClass(2)=Class'WaterVertSplashA02'
	SplashClass(3)=Class'WaterVertSplashA03'
	SplashClass(4)=Class'WaterVertSplashA04'
	SplashClass(5)=Class'WaterVertSplashA05'
	SplashClass(6)=Class'WaterVertSplashA06'
	SplashClass(7)=Class'WaterVertSplashA07'
	BallisticSplashClass(0)=Class'BalWaterSplash00'
	BallisticSplashClass(1)=Class'BalWaterSplash01'
	BallisticSplashClass(2)=Class'BalWaterSplash02'
	BallisticSplashClass(3)=Class'BalWaterSplash03'
	WaterRingClass=Class'WaterSplashRing'
