...
defaultproperties
{
	...
	BehinViewViewOffset=(X=-300.000000,Y=0.000000,Z=150.000000)
	...
	BackwardsLights(0)=(VLightOffset=(X=-186.300003,Y=-122.599998,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	BackwardsLights(1)=(VLightOffset=(X=-186.300003,Y=-114.599998,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	BackwardsLights(2)=(VLightOffset=(X=-186.300003,Y=-106.599998,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	BackwardsLights(3)=(VLightOffset=(X=-186.300003,Y=107.400002,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	BackwardsLights(4)=(VLightOffset=(X=-186.300003,Y=115.400002,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	BackwardsLights(5)=(VLightOffset=(X=-186.300003,Y=123.400002,Z=-22.400000),VLightTex=Texture'XWheelVeh.Misc.JeepBackL',VSpriteProj=2.500000,VLightScale=0.250000)
	HeadLights(0)=(VLightOffset=(X=187.500000,Y=53.599998,Z=-49.299999),VLightTex=Texture'XWheelVeh.Misc.JeepHeadL',VSpriteProj=1.250000,VLightScale=0.440000,VHeadLight=(bHaveSpotLight=True,HeadLightIntensity=80,HLightSat=255,HeadCone=64,HeadDistance=192))
	HeadLights(1)=(VLightOffset=(X=187.500000,Y=-56.400002,Z=-49.299999),VLightTex=Texture'XWheelVeh.Misc.JeepHeadL',VSpriteProj=1.250000,VLightScale=0.440000,VHeadLight=(bHaveSpotLight=True,HeadLightIntensity=80,HLightSat=255,HeadCone=64,HeadDistance=192))
	HeadLights(2)=(VLightOffset=(X=187.500000,Y=43.599998,Z=-48.299999),VLightTex=Texture'XWheelVeh.Misc.JeepHeadL',VSpriteProj=1.250000,VLightScale=0.440000)
	HeadLights(3)=(VLightOffset=(X=187.500000,Y=-46.299999,Z=-48.299999),VLightTex=Texture'XWheelVeh.Misc.JeepHeadL',VSpriteProj=1.250000,VLightScale=0.440000)
