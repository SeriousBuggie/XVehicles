...
defaultproperties
{
      ...
      Treads(0)=(MovPerTreadCycle=19.375000,TreadMesh=LodMesh'XTreadVeh.TankTreadBMir',TreadSkinN=1,TreadOffset=(X=-5.000000,Y=-94.500000,Z=-15.000000),bHaveAnimTWheels=True,WheelFramesN=17,WheelAnimSet="WheelsMove",WheelSize=20.625000,TrackWidth=52.000000,TrackFrontOffset=(X=128.000000),TrackBackOffset=(X=-128.000000))
      Treads(1)=(MovPerTreadCycle=19.375000,TreadMesh=LodMesh'XTreadVeh.TankTreadB',TreadSkinN=1,TreadOffset=(X=-5.000000,Y=94.500000,Z=-15.000000),bHaveAnimTWheels=True,WheelFramesN=17,WheelAnimSet="WheelsMove",WheelSize=20.625000,TrackWidth=52.000000,TrackFrontOffset=(X=128.000000),TrackBackOffset=(X=-128.000000))
      ...
      bDriverWOffset=True
      DriverWeapon=(WeaponClass=Class'XTreadVeh.TankMLTurret',WeaponOffset=(X=-68.000000,Z=64.000000))
      bSlopedPhys=True
      ...
      ArmorType(0)=(ArmorLevel=0.950000,ProtectionType="Burned")
